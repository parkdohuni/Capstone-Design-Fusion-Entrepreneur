...
import com.example.cooperar.databinding.MatchingCardBinding

class MatchingAdapter() :
    RecyclerView.Adapter<MatchingAdapter.MyViewHolder>() {

    class MyViewHolder(private val binding: MatchingCardBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            MatchingCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
