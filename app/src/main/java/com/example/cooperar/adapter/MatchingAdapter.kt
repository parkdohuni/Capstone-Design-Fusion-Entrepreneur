...
import com.example.cooperar.ui.DetailFragment
import com.example.cooperar.ui.MatchingFragment
...
class MatchingAdapter(private val parentFragment: Fragment) :
 RecyclerView.Adapter<MatchingAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action = MatchingFragmentDirections.actionMatchingFragmentToDetailFragment(match)
